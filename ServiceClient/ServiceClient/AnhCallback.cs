...
namespace ServiceClient
{
    ...
    public class AnhCallback : ServiceClient.ANHService.IAnhServiceCallback
    {
        ...
        public void ServerMessage(ANHService.ServerType ServType, string Args, ANHService.MessageType MessType, string Message)
        {
            throw new NotImplementedException();
        }

        public void AvailableServers(ANHService.ServerType[] servers)
        {
            throw new NotImplementedException();
        }
    }
