...
namespace ANHDBI
{
    public class SqlLogin
    {
        ...
        public SqlLogin(DatabaseTypes DatabaseType)
        {
        ...
        public SqlLogin(DatabaseTypes DatabaseType, string Filename)
        {
            oDatabaseType = DatabaseType;
        ...
        public SqlLogin(DatabaseTypes DatabaseType, string Hostname, string Username, string Password, string Database, string Port)
        {
            oDatabaseType = DatabaseType;
            ...
            if (int.Parse(Port) > 0)
            {
                ...
                sPort = "3306";
            // TCP 3306 is MySQL Server Default Port
        ...
        /// <param name="Port">The port.</param>
        /// <param name="Filename">The filename.</param>
        public SqlLogin(DatabaseTypes DatabaseType, string Hostname, string Username, string Password, string Database, string Port, string Filename)
        {
            oDatabaseType = DatabaseType;
            ...
            sPassword = Password;
            sDatabase = Database;
            sPort = "";             // TCP 3306 is MySQL Server Default Port
        ...
        public void Save()
        {
            if (sUserfile != "")
            {
                XmlSerializer xSerializer = new XmlSerializer(typeof(SqlLogin));
            ...
            if (File.Exists(Filename))
            {
                ...
                try
                {
                    ...
                    if (fsStream != null)
                    {
                        ...
                        if (xReader != null)
                        {
                            SqlLogin sqlLogin = xSerializer.Deserialize(xReader) as SqlLogin;
