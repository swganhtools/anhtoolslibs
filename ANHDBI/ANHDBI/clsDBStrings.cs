...
namespace ANHDBI
{
    public static class clsDBStrings
    {
        ...
        public static string utilitydbcon = "Server=" + System.Configuration.ConfigurationManager.AppSettings["utilityhost"] + ";Port=" + System.Configuration.ConfigurationManager.AppSettings["utilityport"] + ";Uid=" + System.Configuration.ConfigurationManager.AppSettings["utilityuser"] + ";Pwd=" + System.Configuration.ConfigurationManager.AppSettings["utilitypassword"] + ";Database=" + System.Configuration.ConfigurationManager.AppSettings["utilitydatabase"] + ";";
    }
}
