...
namespace AnhServiceClient.ANHService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ANHService.IAnhService", CallbackContract=typeof(AnhServiceClient.ANHService.IAnhServiceCallback), SessionMode=System.ServiceModel.SessionMode.Required)]
    public interface IAnhService {
        ...
        string StartServer(AnhServiceClient.ANHService.ServerType type, string args);
        ...
        string StopServer(AnhServiceClient.ANHService.ServerType type, string args);
    ...
    public interface IAnhServiceCallback {
        ...
        void ServerMessage(AnhServiceClient.ANHService.ServerType ServType, string Args, AnhServiceClient.ANHService.MessageType MessType, string Message);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IAnhService/ServerStatus")]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(object[]))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AnhServiceClient.ANHService.ServerType))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AnhServiceClient.ANHService.MessageType))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(AnhServiceClient.ANHService.ServerType[]))]
        ...
        void AvailableServers(AnhServiceClient.ANHService.ServerType[] servers);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAnhServiceChannel : AnhServiceClient.ANHService.IAnhService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AnhServiceClient : System.ServiceModel.DuplexClientBase<AnhServiceClient.ANHService.IAnhService>, AnhServiceClient.ANHService.IAnhService {
        ...
        public string StartServer(AnhServiceClient.ANHService.ServerType type, string args) {
            return base.Channel.StartServer(type, args);
        }
        
        public string StopServer(AnhServiceClient.ANHService.ServerType type, string args) {
